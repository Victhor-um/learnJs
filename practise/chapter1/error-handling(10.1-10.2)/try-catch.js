...
/**
 * Аргумент в catch - объект, который имеет два основныз свойства:
 * 1.name - имя ошибки. Например ReferenceError
 * 2. message - текстовое сообщение о деталях ошибки.
 * 3. stack - текущий стек вызова: строка, содержащая информацию о последовательности вложенных вызовов, которые привели к ошибке
 */
